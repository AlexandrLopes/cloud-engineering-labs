...
Every vulnerable finding is also written to the `SecurityAlerts` DynamoDB table (see `dynamodb-security-log` in this portfolio). Best-effort — a missing table doesn't stop the audit.
